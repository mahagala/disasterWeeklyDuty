...
function getCanvasXY(lat, lng) {
  ...
  // 擬合出的 Robinson 投影 X 轉換公式 (解決緯度越高、經度點向中心收縮的問題，消除日本與韓國偏東誤差)
  const svgX = 5.670235 * lng * (1.0 - 0.00006 * lat * lat) + 991.732073;
  
  // 擬合出的線性 Y 轉換公式 (基於日本本島、韓國、歐洲等真實質心點校正，解決高緯度地區偏北與東亞偏南的問題)
  const svgY = -6.231288 * lat + 495.310959;
